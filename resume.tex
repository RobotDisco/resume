...
\cventry{2016--}{Site Reliability Engineer}{Tulip}{Toronto}{}{
  \begin{itemize}
  \item Convert system reliability/deployment/measurability gaps into tooling, knowledge, automation or processes.
  ...
  \item Designed stack-agnostic standard for continuous integration that all developer teams could use for automatic partipication in our continuous integration platform.
  \item Implemented continuous integration and automated testing harness for the tooling which generated core solution infrastructure for every new client.
  ...
  \item Promote and foster a devops culture of empathy, sustainability and reliability through SRE advocacy, information sharing, blameless portmortems, and other important values in the SRE/devops framework.
  \end{itemize}}
\cventry{2015--2016}{Software Developer}{Tulip}{Toronto, ON}{}{
  ...
  \item Built a variety of sales demo environments, in whatever tech stacks necessary, built around customizations of presentation and flow on our existing deployed product in a variety of timelines and scopes, to deliver sales proposals finely tuned to individual prospects
  \item Implemented a custom checkout process, featuring previews and product customizations, around a newly implemented monogramming service for a client
...
\cventry{2013--2014}{Senior Software Developer / Team Lead}{Gallop Labs}{Toronto, ON}{}{
  \begin{itemize}
  \item Develop a Django \& Couchbase service-oriented architecture for optimizing Facebook campaigns via performance and user analytic data
...
\cventry{2011--2013}{Business Infrastructure Engineer}{Kontagent}{Toronto, ON}{}{
  ...
  \item Created development processes and infrastructure for new applications, using Vagrant for local virtualization and Puppet for seamless deployment across development, staging, and production
  ...
  \item Conducted post-mortems on department's previous failed initiatives, restarted initiatives while accounting for factors in department's previous failures
...
\cventry{2007--2011}{Support Engineer}{Blue Coat Systems}{Waterloo, ON}{}{
  \begin{itemize}
  \item Restructured monolithic, inadequately-tested medium-level operating system components into well-tested modular designs without breaking customer, QA expectations
  ...
  \item Ported libpcre (a popular regular expression library) onto a custom operating system, adapting it for our unique handling of memory and multiprocessing
  \item Extended a boost-inspired standard library for a proprietery embedded operating system designed to concurrently operate with memory and soft realtime constraints
  ...
  \item Delved into semi-familiar component codebases to fix defects and supply workarounds, including:
    ...
    \end{itemize}
  \item Utilized custom-generated configuration files, memory dumps, annotated assembly code, and GDB on optimized code in order to understand product's state at failure
...
\cventry{2006--2006}{Co-op Software Developer}{Blue Coat Systems}{Waterloo, ON}{}{
  \begin{itemize}
  \item Developed custom continuous integration system to poll an externally controlled source repository server for new project revisions for testing and report-generation
  \item Primary tools: C++, GDB, Python
  \end {itemize}}
\cventry{2005--2005}{Co-op Software Developer}{Community Care Access Centre}{Kitchener, ON}{}{
  \begin{itemize}
  \item Restructured the core logic of a secure health information service deployed by sister corporations in several regions across Ontario
  ...
  \item Primary Tools: Java, Apache Tomcat
  \end{itemize}}
